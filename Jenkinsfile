...
//     }
   ...
   stage('Docker build and push') {
	 ...
	 echo $secret_key
         ...
         docker login -u AWS -p $DOCKER_LOGIN_PASSWORD 645624701308.dkr.ecr.eu-central-1.amazonaws.com/demoproject
	 docker build -t 645624701308.dkr.ecr.eu-central-1.amazonaws.com/demoproject:SAMPLE-PROJECT-${BUILD_NUMBER} .
	 docker push 645624701308.dkr.ecr.eu-central-1.amazonaws.com/demoproject:SAMPLE-PROJECT-${BUILD_NUMBER}
